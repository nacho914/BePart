...
class iniciativaRepositoryImpl(private val iniciativesRepository: iniciativasRepository): iniciativasRepository {
    ...
    override suspend fun addIniciativatoFireStore(iniciativa: Initiatives): Flow<Result<Initiatives, Error>> {
        return iniciativesRepository.addIniciativatoFireStore(iniciativa)
    }
